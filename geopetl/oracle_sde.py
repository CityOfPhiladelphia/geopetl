...
class OracleSdeTable(object):
    ...
    def _get_srid(self):
        ...
        if srid:
            bad_srid_map = {300102: 4326, 300103: 4326, 300001: 2272, 300003: 2272, 300046: 2272, 300006: 2272, 300010: 2272, 300008: 2272, 300004: 2272, 300007: 2272, 300067: 2272, 300100: 2272, 300101: 2272, 300084: 3857, 300073: 4326, 300042: 4326, 300090: 4269, 300091: 4326, 300092: 4326, 300042: 4326, 300086: 6565, 300087: 6565 }
            if srid in bad_srid_map.keys():
                # Reassign our bad SRID to a typical one.
                print(f'Bad SRID detected, reassigning {srid} to {bad_srid_map[srid]}')
